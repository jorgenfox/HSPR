...
const fetchRecentResults = (limit, searchParams, callback) => {
    ...
    // Default ORDER BY clause (descending by tulemus.id)
...
// The getRecentResults and renderRecentResults endpoints read eesnimi, perenimi, ala, and hooaeg from the request query parameters and pass them to fetchRecentResults.
...
exports.updateResult = (req, res) => {
    ...
    console.log('Received data:', { id, eesnimi, perenimi, meetrid, sugu, ala });
